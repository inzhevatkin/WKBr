...
# I compare scattnlay, WKB, WKBr v.1 ...

size = 100
grid = 160
type = "bhfield" # "WKB from ADDA" # "bhfield" #  scattnlay
m = [1.01]  # , 1.05, 1.1, 1.2, 1.3
m_im = 0
...
if __name__ == "__main__":
    ...
    for i in m:
        ...
        # Создадим объект класса, который будет ограничивать области.
        ...
        if type == "bhfield" or type == "scattnlay":
            ...
            # if not os.path.exists(pathsc_adda) or os.path.getsize(pathsc_adda) == 0:
        ...
        if version == "wkb":
            ...
            aver_error_l2, aver_error_l2_one_root, aver_error_l2_two_root, aver_error_l2_no_root,\
                ...
                compare(pathsc_adda, path_wkb, size / 2, i)
            f0.write(str(i) + ' ' +
                     str(aver_error_l2) + ' ' +
            ...
            aver_error_l2, aver_error_l2_one_root, aver_error_l2_two_root, aver_error_l2_no_root,\
                aver_error_l1, aver_error_l1_one_root, aver_error_l1_two_root, aver_error_l1_no_root = \
                compare(pathsc_adda, path_wkb_refraction, size / 2, i)
            f1.write(str(i) + ' ' +
                     str(aver_error_l2) + ' ' +
                     str(aver_error_l2_one_root) + ' ' +
                     str(aver_error_l2_two_root) + ' ' +
            ...
            aver_error_l2, aver_error_l2_one_root, aver_error_l2_two_root, aver_error_l2_no_root,\
                aver_error_l1, aver_error_l1_one_root, aver_error_l1_two_root, aver_error_l1_no_root = \
                compare(pathsc_adda, path_wkb_refraction2, size / 2, i)
            f2.write(str(i) + ' ' +
                     str(aver_error_l2) + ' ' +
                     str(aver_error_l2_one_root) + ' ' +
                     str(aver_error_l2_two_root) + ' ' +
            ...
            aver_error_l2, aver_error_l2_one_root, aver_error_l2_two_root, aver_error_l2_no_root,\
                aver_error_l1, aver_error_l1_one_root, aver_error_l1_two_root, aver_error_l1_no_root = \
                compare(pathsc_adda, path_wkb_refraction3, size / 2, i)
            f3.write(str(i) + ' ' +
                     str(aver_error_l2) + ' ' +
                     str(aver_error_l2_one_root) + ' ' +
                     str(aver_error_l2_two_root) + ' ' +
            ...
            aver_error_l2, aver_error_l2_one_root, aver_error_l2_two_root, aver_error_l2_no_root,\
                aver_error_l1, aver_error_l1_one_root, aver_error_l1_two_root, aver_error_l1_no_root = \
                compare(pathsc_adda, path_wkb_refraction4, size / 2, i)
            f4.write(str(i) + ' ' +
                     str(aver_error_l2) + ' ' +
                     str(aver_error_l2_one_root) + ' ' +
                     str(aver_error_l2_two_root) + ' ' +
            ...
            aver_error_l2, aver_error_l2_one_root, aver_error_l2_two_root, aver_error_l2_no_root, \
            aver_error_l1, aver_error_l1_one_root, aver_error_l1_two_root, aver_error_l1_no_root = \
                compare(pathsc_adda, path_wkb_refraction5, size / 2, i)
            f5.write(str(i) + ' ' +
                     str(aver_error_l2) + ' ' +
                     str(aver_error_l2_one_root) + ' ' +
                     str(aver_error_l2_two_root) + ' ' +
